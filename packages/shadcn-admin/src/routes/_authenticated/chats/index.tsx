...
// Chat data and types - moved from features/chats/data/
...
// NewChat component - moved from features/chats/components/new-chat.tsx
function NewChat({ 
  users, 
  onOpenChange, 
  open 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          <DialogTitle><Trans>New message</Trans></DialogTitle>
        </DialogHeader>
        <div className='flex flex-col gap-4'>
          <div className='flex flex-wrap items-center gap-2'>
            <span className='text-muted-foreground text-sm'><Trans>To:</Trans></span>
          ...
          <Command className='rounded-lg border'>
            ...
            />
            <CommandList>
              <CommandEmpty><Trans>No people found.</Trans></CommandEmpty>
              <CommandGroup>
                {users.map((user) => (
                  <CommandItem
                    key={user.id}
...
// Main Chats component - moved from features/chats/index.tsx
function Chats() {
            ...
            <div className='bg-background sticky top-0 z-10 -mx-4 px-4 pb-3 shadow-md sm:static sm:z-auto sm:mx-0 sm:p-0 sm:shadow-none'>
              <div className='flex items-center justify-between py-2'>
                <div className='flex gap-2'>
                  <h1 className='text-2xl font-bold'><Trans>Inbox</Trans></h1>
              ...
              <label className='border-input focus-within:ring-ring flex h-12 w-full items-center space-x-0 rounded-md border pl-2 focus-within:ring-1 focus-within:outline-hidden'>
                ...
                <span className='sr-only'><Trans>Search</Trans></span>
                <input
                  type='text'
              ...
              <div className='flex flex-1 flex-col gap-2 rounded-md px-4 pt-0 pb-4'>
                ...
                <form className='flex w-full flex-none gap-2'>
                  ...
                  <Button className='h-full sm:hidden'>
                    <IconSend size={18} /> <Trans>Send</Trans>
                  </Button>
                </form>
              </div>
            </div>
            ...
            >
              <div className='flex flex-col items-center space-y-6'>
                ...
                <div className='space-y-2 text-center'>
                  <h1 className='text-xl font-semibold'><Trans>Your messages</Trans></h1>
                  <p className='text-muted-foreground text-sm'>
                    <Trans>Send a message to start a chat.</Trans>
                  </p>
                </div>
                <Button
