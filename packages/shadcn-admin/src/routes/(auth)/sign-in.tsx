...
// Main SignIn component - moved from features/auth/sign-in/index.tsx
function SignIn() {
  return (
    <AuthLayout>
      <Card className='gap-4'>
        <CardHeader>
          <CardTitle className='text-lg tracking-tight'><Trans>Login</Trans></CardTitle>
          <CardDescription>
            <Trans>Enter your email and password below to</Trans> <br />
